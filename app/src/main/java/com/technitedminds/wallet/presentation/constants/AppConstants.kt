...
This action cannot be undone."""
    ...
    object UIText {
        ...
        const val APPEARANCE_SUBTITLE = "Customize card colors"
        ...
        const val CARD_DETAILS_SUBTITLE = "OCR extracted information"
        ...
        const val CUSTOM_FIELDS_SUBTITLE = "Custom fields and notes"
...
For questions, contact: privacy@cardvault.app"""
        ...
        const val SAVE_CHANGES_REMINDER = "Don't forget to save your changes using the check button in the top bar."
